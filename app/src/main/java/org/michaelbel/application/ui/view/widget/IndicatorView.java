...
public class IndicatorView extends LinearLayout {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorWidth = (mIndicatorWidth < 0) ? Utils.dp(context, DEFAULT_INDICATOR_WIDTH) : mIndicatorWidth;
        mIndicatorHeight = (mIndicatorHeight < 0) ? Utils.dp(context, DEFAULT_INDICATOR_WIDTH) : mIndicatorHeight;
        mIndicatorMargin = (mIndicatorMargin < 0) ? Utils.dp(context, DEFAULT_INDICATOR_WIDTH) : mIndicatorMargin;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.indicator_view_anim, 0, R.drawable.indicator_circle, R.drawable.indicator_circle);
    }
    ...
    /*public IndicatorView setIndicatorColor(@ColorInt int color) {
        return this;
    }*/
