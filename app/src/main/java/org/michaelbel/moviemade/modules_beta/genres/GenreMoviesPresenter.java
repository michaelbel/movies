...
public class GenreMoviesPresenter extends MvpPresenter<ResultsMvp> {
    ...
    public void loadFirstPage(int genreId) {
        ...
        Observable<MoviesResponse> observable = service.getMovies(genreId, BuildConfig.TMDB_API_KEY, Url.en_US, AndroidUtils.includeAdult(), page).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
