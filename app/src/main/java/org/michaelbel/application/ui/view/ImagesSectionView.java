...
public class ImagesSectionView extends FrameLayout {
    ...
    public ImagesSectionView(Context context) {
        ...
        imagesLayout.setLayoutParams(LayoutHelper.makeFrame(LayoutHelper.MATCH_PARENT, 150,
                Gravity.TOP, 12, 48, 12, 12));
        addView(imagesLayout);

        //---

        FrameLayout postersLayout = new FrameLayout(context);
        postersLayout.setLayoutParams(LayoutHelper.makeLinear(0, LayoutHelper.MATCH_PARENT,
                Gravity.CENTER, 1F));
        ...
        postersTitleLayout.setLayoutParams(LayoutHelper.makeFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT,
                Gravity.BOTTOM));
        ...
        postersCountTextView.setLayoutParams(LayoutHelper.makeFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT,
                Gravity.START | Gravity.CENTER_VERTICAL, 8, 6, 8, 6));
        postersTitleLayout.addView(postersCountTextView);

//--------------------------------------------------------------------------------------------------

        FrameLayout backdropsLayout = new FrameLayout(context);
        backdropsLayout.setLayoutParams(LayoutHelper.makeLinear(0, LayoutHelper.MATCH_PARENT,
                Gravity.CENTER,2F, 12, 0, 0, 0));
        ...
        backdropsTitleLayout.setLayoutParams(LayoutHelper.makeFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT,
                Gravity.BOTTOM));
        ...
        backdropsCountTextView.setLayoutParams(LayoutHelper.makeFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT,
                Gravity.START | Gravity.CENTER_VERTICAL, 8, 6, 8, 6));
    ...
    public ImagesSectionView setBackdrop(@NonNull String backdropPath) {
        ...
        Glide.with(getContext())
                .load("http://image.tmdb.org/t/p/" + size +"/" + backdropPath)
                .into(backdropImageView);
        return this;
    }

    public ImagesSectionView setPostersCount(int count) {
        postersCountTextView.setText(count + " Posters");
        return this;
    }

    public ImagesSectionView setBackdropsCount(int count) {
        backdropsCountTextView.setText(count + " Backdrops");
        return this;
    }
}