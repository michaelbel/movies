...
class WatchlistRepository(private val service: AccountService): WatchlistContract.Repository {

    override fun getWatchlistMovies(accountId: Int, sessionId: String, page: Int): Observable<List<Movie>> =
