...
public class SpannableUtil {
    ...
    public static SpannableStringBuilder replaceTags2(String str, int flag, Object... args) {
        try {
            ...
            for (int a = 0; a < bolds.size() / 2; a++) {
                spannableStringBuilder.setSpan(new TypefaceSpan("sans-serif-medium"), bolds.get(a * 2), bolds.get(a * 2 + 1), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                spannableStringBuilder.setSpan(new ForegroundColorSpan(ContextCompat.getColor(App.Companion.getAppContext(), R.color.textColorPrimary)), bolds.get(a * 2), bolds.get(a * 2 + 1), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
    ...
    public static SpannableStringBuilder boldAndColoredText(String title, String allText) {
        ...
        spannable.setSpan(new ForegroundColorSpan(ContextCompat.getColor(App.Companion.getAppContext(), R.color.textColorPrimary)), startPos, endPos, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
