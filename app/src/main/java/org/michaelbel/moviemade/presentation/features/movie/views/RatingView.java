...
public class RatingView extends LinearLayoutCompat {
    ...
    private class StarView extends AppCompatImageView {
        ...
        public void setIcon(int style) {
            if (style == ICON_STAR) {
                icon = ViewUtil.INSTANCE.getIcon(getContext(), R.drawable.ic_star, ContextCompat.getColor(getContext(), R.color.accent_yellow));
            } else if (style == ICON_STAR_HALF) {
                icon = ViewUtil.INSTANCE.getIcon(getContext(), R.drawable.ic_star_half, ContextCompat.getColor(getContext(), R.color.accent_yellow));
            } else if (style == ICON_STAR_BORDER) {
                icon = ViewUtil.INSTANCE.getIcon(getContext(), R.drawable.ic_star_border, ContextCompat.getColor(getContext(), R.color.accent_yellow));
            }
