...
public class CompanyMoviesPresenter extends MvpPresenter<ResultsMvp> {
    ...
    public void loadMovies(int companyId) {
        ...
        Observable<MoviesResponse> observable = service.getMovies(companyId, BuildConfig.TMDB_API_KEY, Url.en_US).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
