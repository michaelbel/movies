...
public class ReviewsFragment extends MvpAppCompatFragment implements ReviewsMvp {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        emptyView.setOnClickListener(v -> {
            ...
            presenter.loadReviews(activity.movieId);
        });
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!presenter.isLoading && !presenter.isLastPage) {
                    if ((visibleItemCount + firstVisibleItemPosition) >= totalItemCount && firstVisibleItemPosition >= 0) {
                        ...
                        presenter.page++;
                        presenter.loadReviewsNext(activity.movieId);
                    }
                }
            }
        });
    ...
    @Override
    public void setReviews(List<Review> reviews, boolean firstPage) {
    ...
    @Override
    public void showError(@EmptyViewMode int mode) {
