...
import org.michaelbel.moviemade.ui.adapter.SearchCollectionsAdapter;
...
public class SearchCollectionsFragment extends MvpAppCompatFragment implements MvpSearchView {
    ...
    private SearchCollectionsAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new SearchCollectionsAdapter(searches);
    ...
    @Override
    public void searchComplete(List<TmdbObject> collections, int totalResults) {
        searches.addAll(collections);
        adapter.notifyItemRangeInserted(searches.size() + 1, collections.size());
    ...
    @Override
    public void nextPageLoaded(List<TmdbObject> collections) {
        searches.addAll(collections);
        adapter.notifyItemRangeInserted(searches.size() + 1, collections.size());
    }
    ...
    public boolean empty() {
        return adapter.getCollections().isEmpty();
    }
}