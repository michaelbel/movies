...
public class IndicatorView extends LinearLayout {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_ci_width, -1);
        mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_ci_height, -1);
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.IndicatorView_ci_margin, -1);
        mAnimatorResId = typedArray.getResourceId(R.styleable.IndicatorView_ci_animator, R.animator.scale_with_alpha);
        mAnimatorReverseResId = typedArray.getResourceId(R.styleable.IndicatorView_ci_animator_reverse, 0);
        mIndicatorBackgroundResId = typedArray.getResourceId(R.styleable.IndicatorView_ci_drawable, R.drawable.white_radius);
        mIndicatorUnselectedBackgroundResId = typedArray.getResourceId(R.styleable.IndicatorView_ci_drawable_unselected, mIndicatorBackgroundResId);

        int orientation = typedArray.getInt(R.styleable.IndicatorView_ci_orientation, -1);
        setOrientation(orientation == VERTICAL ? VERTICAL : HORIZONTAL);

        int gravity = typedArray.getInt(R.styleable.IndicatorView_ci_gravity, -1);
