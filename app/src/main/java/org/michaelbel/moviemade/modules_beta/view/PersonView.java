...
import org.michaelbel.moviemade.modules_beta.view.widget.MaskImageView;
...
public class PersonView extends FrameLayout {
    ...
    public PersonView(Context context) {
        ...
        nameText.setTextColor(ContextCompat.getColor(context, R.color.primaryText));
        ...
        characterText.setTextColor(ContextCompat.getColor(context, R.color.secondaryText));
